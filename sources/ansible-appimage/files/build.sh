...
# Install pyenv
curl -sLm 11 https://github.com/pyenv/pyenv-installer/raw/master/bin/pyenv-installer |
  bash
eval "$(pyenv init -)"
...
ARCH="$(uname -m)"
curl -sLo appimagetool.AppImage "https://github.com/AppImage/appimagetool/releases/\
latest/download/appimagetool-${ARCH}.AppImage"
